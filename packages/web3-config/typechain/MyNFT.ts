...
export interface MyNFTInterface extends utils.Interface {
  ...
  functions: {
    ...
    "nftSpreadContract()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "nftSpreadContract",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface MyNFT extends BaseContract {
  ...
  functions: {
    ...
    nftSpreadContract(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    nftSpreadContract(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    nftSpreadContract(overrides?: CallOverrides): Promise<PopulatedTransaction>;
